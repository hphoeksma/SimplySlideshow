...
/**
 * Test case for class Tx_Simply_slideshow_Controller_SlideshowController.
 *
 * @version $Id$
 ...
 */
class Tx_Simply_slideshow_Controller_SlideshowControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
