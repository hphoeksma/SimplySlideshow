...
/**
 * Test case for class Tx_Simply_slideshow_Controller_ImageController.
 *
 * @version $Id$
 ...
 */
class Tx_Simply_slideshow_Controller_ImageControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
